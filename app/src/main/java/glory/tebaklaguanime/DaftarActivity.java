        ...
        fAuth.createUserWithEmailAndPassword(email,passwordUser).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (!task.isSuccessful()){
                    ...
                    userDaftarModel = new UserDaftar(userID,
                    ...
                    levelModel = new Level("T","T","T","T","T");

                    ref = ref.child("users");
                    ref.child(userID).setValue(userDaftarModel);
                    ref.child(userID).child("level").setValue(levelModel);

                    Toast.makeText(DaftarActivity.this,"Register Succes ! Please go to Login page \n" +
